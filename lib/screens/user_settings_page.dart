...
class _UserSettingsPageState extends State<UserSettingsPage> {
      ...
      if (currentUser != null) {
        ...
        if (userDoc.exists) {
          setState(() {
            ...
            _interestsController = TextEditingController(text: _user!.interests.join(', '));
            _isLoading = false;
          });
        }
      }
  ...
  Future<void> _saveSettings() async {
    ...
    final updatedUser = UserModel(
      id: _user!.id,
      email: _user!.email,
      photoUrl: _user!.photoUrl, // Update photo URL after uploading the new image if necessary
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text("Save Settings", style: TextStyle(fontSize: 18, color: Colors.black,)),
              ),
            ),
          ],
        ),
