import 'package:blog_app/features/update_post.dart';
...
class _EditPostPageState extends State<EditPostPage> {
  ...
  Future<void> _updatePost() async {
    ...
    await updatePost(postId: postId, title: title, categories: _selectedCategories, content: content, imageUrl: imageUrl); // Ensure `updatePost` is defined
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text("Update Post", style: TextStyle(fontSize: 18, color: Colors.white)),
              ),
            ),
          ],
        ),
